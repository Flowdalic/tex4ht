...
\def\overwithdelims:III#1#2#3{%
   ...
   \else
      \Send{GROUP}{0}{<\a:mathml mfenced \a:mathml separators=""\Hnewline
          \a:mathml open="|<lr del 2|>" \a:mathml close="|<lr del 3|>"><\a:mathml mfrac><\a:mathml mrow>}%
      \HCode{</\a:mathml mrow>}\o:over:
      \HCode{<\a:mathml mrow>}\Send{EndGROUP}{0}{</\a:mathml 
                               mrow></\a:mathml mfrac></\a:mathml mfenced>}
   \fi
...
Fix the \verb|\int| command -- it should produce the \verb|<mo>| element.
...
\<unicode enspace\><<<
\leavevmode\special{t4ht@+\string&{35}x2002{59}}x%
>>>
